                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card bg-dark text-light shadow-sm h-100">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title mb-1">Nimal Perera [ 0764393083 ]</h5>
                                    <p class="text-secondary small mb-2">
                                         <i class="bi bi-geo-alt"></i> &nbsp;Negombo Branch
                                      
                                    </p>

                                    <p class="mb-1">
                                        <i class="bi bi-clock"></i>&nbsp; <span class="badge bg-warning text-dark">10:30 AM</span> 
                                    </p>
                                    <p class="mb-3">
                                        <i class="bi bi-calendar-date"> </i>&nbsp; <span class="badge bg-warning text-dark font-monospace">2025-05-20</span> 
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card bg-dark text-light shadow-sm h-100">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title mb-1">Policy Discussion</h5>
                                    <p class="text-secondary small mb-2">
                                        <i class="bi bi-person"></i> Kasun Silva
                                    </p>
                                    ...
                                    <p class="mb-3">
                                        <i class="bi bi-geo-alt"></i> Online
                                    </p>
