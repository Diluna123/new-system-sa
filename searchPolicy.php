                        ...
                        <div class="row mt-2">
                            <div class="row justify-content-center align-items-center g-2">
                                ...
                                <div class="col-12 col-md-auto text-center text-md-end">
                                    <label for="policyNumber" class="form-label mb-0">
                                        Policy Number :
                                    </label>
                                </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-5">
                                    <div class="input-group input-group-sm ms-3">
                                        ...
                                        <button class="btn btn-primary" type="button" onclick="searchPolicy();">
                                            Search
                                        </button>
                            ...
                            <div class="col-12">
                                <div class="row mt-4 ms-3" id="searcResults">
