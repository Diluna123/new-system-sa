...
<head>
    ...
    <style>
        ...
        /* -------------------------------------------
        MODERN UI/UX Enhancements (New/Modified CSS)
        ------------------------------------------- 
        */
        ...
        /* 3. Sidebar Link Hover Effect (using Bootstrap's .nav-link) */
        .sidebar .nav-link:hover {
            color: var(--bs-primary) !important;
            /* Use primary color for hover */
            background-color: rgba(26, 156, 243, 0.1);
            /* Subtle background glow */
        }
        
        /* Existing progress bar animation CSS (kept for completeness) */
        .progress-bar {
...
<body>
    <?php if (isset($_SESSION['user'])) { ?>
        ...
        <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
            <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">SANASA LIFE &nbsp; <small class="text-secondary fw-light"> version 2.0.7.1</small></a>
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" id="main-dev"> 
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        <div class="btn-toolbar mb-2 mb-md-0 dropdown">
                            <button class="btn btn-sm border-0 d-flex align-items-center text-white px-2" type="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="me-2 d-none d-md-inline"><?php echo $_SESSION['user']['u_fname'] . " " . $_SESSION['user']['u_lname']; ?></span>
                                <div class="proPic bg-secondary d-flex justify-content-center align-items-center" style="width: 32px; height: 32px; border-radius: 50%;">
                                ...
                                <div class="card-body">
                                    <div class="row g-3 text-center">
                                        ...
                                        <div class="col-12 col-md-6 border-md-end">
                                            <h6 class="text-muted mb-1">Total (31)</h6>
                                            <h4 class="fw-bold text-primary mb-2" id="total31" data-target-value="31">0</h4>
                                            <?php
                                            ...
                                            $premium1 = 0;
                                            if ($nop > 0) {
                                                while ($planData31data = $planData31->fetch_assoc()) {
                                                    $premium1 = $premium1 + $planData31data['ammount'];
                                                }
                                            }
                                            ?>
                                            <p class="mb-1 small"><strong>NOP:</strong> <span id="nop31" data-target-value="<?php echo $nop; ?>">0</span></p>
                                            <p class="mb-0 small"><strong>Premium:</strong> <span id="premium31" data-target-value="<?php echo $premium1; ?>">0.00</span></p>
                                        </div>

                                        <div class="col-12 col-md-6">
                                            <h6 class="text-muted mb-1">Total (18)</h6>
                                            <h4 class="fw-bold mb-2 text-primary" id="total18" data-target-value="18">0</h4>
                                            <?php
                                            ...
                                            if ($nop2 > 0) {
                                                while ($planData18data = $planData18->fetch_assoc()) {
                                                    $premium2 = $premium2 + $planData18data['ammount'];
                                                }
                                            }
                                            ?>
                                            <p class="mb-1 small"><strong>NOP:</strong> <span id="nop18" data-target-value="<?php echo $nop2; ?>">0</span></p>
                                            <p class="mb-0 small"><strong>Premium:</strong> <span id="premium18" data-target-value="<?php echo $premium2; ?>">0.00</span></p>
                                        </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js" integrity="sha384-FKyoEForCGlyvwx9Hj09JcYn3nv7wiPVlz7YYwJrWVcXK/BmnVDxM+D2scQbITxI" crossorigin="anonymous"></script>
        ...
        <script>
            // 1. Content Fade-In Function
            document.addEventListener('DOMContentLoaded', () => {
                const mainContent = document.getElementById('main-dev');
                // Use a short delay to ensure all CSS is parsed before triggering the transition
                setTimeout(() => {
                    mainContent.classList.add('loaded');
                }, 100); 
            });

            // 2. KPI Count-Up Function
            function animateValue(obj, start, end, duration) {
                ...
                const step = (timestamp) => {
                    ...
                    if (obj.id.startsWith('premium')) {
                        // Format as currency (2 decimal places)
                        obj.innerHTML = value.toFixed(2);
                    } else {
                        // Format as an integer, using toLocaleString for thousand separators
                        obj.innerHTML = Math.ceil(value).toLocaleString();
                    }
            ...
            function startCountAnimations() {
                const elements = [
                    document.getElementById("total31"),
                    document.getElementById("nop31"),
                    document.getElementById("premium31"),
                    document.getElementById("total18"),
                    document.getElementById("nop18"),
                    document.getElementById("premium18")
                ];

                elements.forEach(el => {
                    if (el) {
                        const targetValue = parseFloat(el.getAttribute('data-target-value'));
                        // Animate from 0 to the target value over 1500ms (1.5 seconds)
                        animateValue(el, 0, targetValue, 1500);
                    }
                });
            }

            // Start the KPI animations once the window is loaded
            window.addEventListener('load', startCountAnimations);
        </script>
        ...
        <script>
            ...
            // ... (Toast script removed for brevity/focus on UI animation)
        </script>
            ...
            new Chart(pieCtx, {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            // Update chart title to reflect last month
