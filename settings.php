                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-lg-6 col-md-6 col-sm-12 mb-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mt-2 d-flex flex-column  " id="vBtn">
                                        <small class="text-secondary">**Check your email and get acivation code to change your password</small>
                                        <div class="mt-2">
                                            <button class="btn btn-sm btn-warning" onclick="verifyEmail(0);">Verify Your Email</button>
                                        </div>
                                    </div>
                                    <div class="text-center d-none " id="vSpinner">
                                        <div class="spinner-border text-secondary" role="status">
                                            <span class="visually-hidden">Loading...</span>
                                        </div>
                                        <h6 class="mt-1 text-secondary" id="loText">Sending verification code to your e-mail</h6>
                                    </div>

                                    <div class="d-none mt-1" id="verifyCode">
                                        <label for="" class="form-label">Verification Code : </label>
                                        <input type="text" class="form-control form-control-sm" id="vCode" placeholder="Verification Code">
                                        <label for="" class="form-label mt-2">New Password : </label>
                                        <input type="text" class="form-control form-control-sm" id="newPass" placeholder="Enter New Password">
                                        <div class="col-12 mt-3 d-flex justify-content-end">
                                            <button class="btn btn-sm btn-outline-secondary" onclick="verifyEmail(1);">Cancel</button>
                                            <button class="btn btn-sm btn-primary ms-2" onclick="changePass();">Change Password</button>
