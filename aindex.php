                        ...
                        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                            ...
                            <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a href="aindex.php" class="nav-link d-flex align-items-center gap-2 active " aria-current="page" onclick="">
                                            <svg class="bi">
                        ...
                        <table class="table table-dark table-hover text-center">
                            <thead>
                                <tr>
                                    ...
                                    <th onclick="sortTable(2)" style="cursor:pointer;">Email <i class="fas fa-sort"></i></th>
                                    <th>Status</th>
                                </tr>
                            </thead>
                            <tbody id="userTable">
                            ...
                            $users = Database::search("SELECT * FROM `users`");
                            if ($users->num_rows > 0) {
                                foreach ($users->fetch_all(MYSQLI_ASSOC) as $user) {
                                    $status = ($user['user_State_id'] == 1) ? 'checked' : '';
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input " type="checkbox" <?php echo $status; ?> onchange="getToggleValue(this,<?php echo $user['u_id']; ?>);">
                                            </div>
                                        </td>
                                    </tr>
                            <?php
